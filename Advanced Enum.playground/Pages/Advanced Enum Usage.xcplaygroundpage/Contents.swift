...
extension Trade3  {
    ...
    static func fromObjc(source: ObjcTrade) -> Trade3? {
        switch (source.type) {
        case 0: return Trade3.buy(stock: source.stock, amount: source.amount)
        case 1: return Trade3.sell(stock: source.stock, amount: source.amount)
        default: return nil
        }
    }
}
